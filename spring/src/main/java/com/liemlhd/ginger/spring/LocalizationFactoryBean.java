...
package com.liemlhd.ginger.spring;

import com.liemlhd.ginger.LocaleResolver;
import com.liemlhd.ginger.Localization;
import com.liemlhd.ginger.LocalizationBuilder;
...
public class LocalizationFactoryBean implements FactoryBean<Localization>, InitializingBean {
    ...
    /**
     * See {@link LocalizationBuilder#withResourceLoader(com.liemlhd.ginger.loader.ResourceLoader)}.
     *
    ...
    /**
     * See {@link LocalizationBuilder#withLocalizationLoader(com.liemlhd.ginger.loader.LocalizationLoader)}
     *
